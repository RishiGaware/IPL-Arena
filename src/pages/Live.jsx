...
export default function Live() {
    ...
    const betStats = useMemo(() => {
        if (!liveMatch || bets.length === 0) {
            return { teamABets: 0, teamBBets: 0, teamAPercent: 50, teamBPercent: 50, totalBets: 0, totalPool: 0 };
        }
                    ...
                    <div className="bg-white dark:bg-primary/5 border border-slate-200 dark:border-primary/10 rounded-xl p-4">
                        <div className="flex justify-between items-center mb-2">
                            <div className="flex items-center gap-2">
                                <img src={getTeamLogo(liveMatch.teamA)} alt="" className="size-5 rounded-full object-contain bg-white" />
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <img src={getTeamLogo(liveMatch.teamB)} alt="" className="size-5 rounded-full object-contain bg-white" />
                            </div>
                        </div>
                        ...
                        <div className="flex justify-between mt-2">
                            <span className="text-[10px] text-slate-500">{betStats.teamAPool?.toLocaleString()} pts</span>
                            <span className="text-[10px] text-slate-500">{betStats.teamBPool?.toLocaleString()} pts</span>
                        </div>
                        <p className="text-[10px] text-center text-slate-500 mt-2 uppercase tracking-wider">
                            Community Bet Distribution • {betStats.totalPool?.toLocaleString()} pts total
                        </p>
                    </div>
                </div>
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="col-span-5 flex items-center gap-2 min-w-0">
                                                ...
                                                <span className={`text-sm font-medium truncate ${isMe ? 'text-primary font-bold' : ''}`}>
                                                    {isMe ? "You" : userName}
                                                </span>
                                            </div>
